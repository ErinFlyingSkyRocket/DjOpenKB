...
def _apply_admin_translation_labels():
    ...
    help_texts = {
        ...
        (SiteSetting, "stray_upload_cleanup_min_age_minutes"): "Uploaded files newer than this many minutes are ignored when they are not referenced by an article or a user-owned New Article checkpoint. Existing checkpoints never expire because of age. Set to 0 only for immediate orphan-file cleanup.",
