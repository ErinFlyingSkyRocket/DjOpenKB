...
def _apply_admin_translation_labels():
    ...
    help_texts = {
        ...
        (SiteSetting, "stray_upload_cleanup_min_age_minutes"): "Ordinary stray files newer than this many minutes are ignored by cleanup. The same value controls abandoned new-article workspaces, but workspaces are never auto-discarded earlier than 1440 minutes (24 hours). Set to 0 only for immediate ordinary stray-file cleanup.",
