    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_video_max_width_px', models.PositiveIntegerField(default=720, help_text='Maximum display width for article video players in pixels. Videos remain responsive and keep a 16:9 ratio on smaller screens. Default is 720 px. Allowed range: 160 to 1920 px.', validators=[MinValueValidator(160), MaxValueValidator(1920)], verbose_name='Article video maximum width (px)')),
                ...
                ('admin_ip_allowlist_enabled', models.BooleanField(default=False, help_text='Disabled by default. When disabled, Django Admin can be reached from any IPv4 or IPv6 address, subject to normal authentication and Admin MFA. When enabled, only the configured IP/CIDR ranges are allowed.', verbose_name='Enable Admin IP allowlist')),
                ('admin_allowed_cidrs', models.TextField(blank=True, default='', help_text='Optional comma, space, or newline separated IPv4/IPv6 addresses or CIDR ranges. Examples: 192.0.2.50, 10.0.0.0/24, 2001:db8::/32. Leave blank while the allowlist is disabled.', verbose_name='Admin allowed IP ranges')),
