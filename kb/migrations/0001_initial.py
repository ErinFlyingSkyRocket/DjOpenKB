    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_video_max_width_px', models.PositiveIntegerField(default=360, help_text='Maximum display width for article video players in pixels. Videos remain responsive and keep a 16:9 ratio on smaller screens. Default is 360 px. Allowed range: 160 to 1920 px.', validators=[MinValueValidator(160), MaxValueValidator(1920)], verbose_name='Article video maximum width (px)')),
