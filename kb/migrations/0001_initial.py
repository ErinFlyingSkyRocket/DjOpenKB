    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_source', models.CharField(choices=[('local', 'Local user'), ('ad', 'Active Directory user')], default='local', help_text='Controls whether the password is managed locally in DjOpenKB or externally by Active Directory.', max_length=20)),
