# Generated for SMTP article-owner decision notification audit event labels.
...
ACTIVITY_EVENT_CHOICES = [
    ...
    ("article_owner_notification_queued", _("Article owner notification queued")),
    ("article_owner_notification_sent", _("Article owner notification sent")),
    ("article_owner_notification_failed", _("Article owner notification failed")),
    ("article_owner_notification_skipped", _("Article owner notification skipped")),
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("kb", "0024_article_review_notification_event_types"),
    ]
