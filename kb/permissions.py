...
ROLE_DEFINITIONS = {
    ...
    ROLE_ARTICLE_WRITER: {
        "description": _(
            "Article contributor. Can view articles, create articles, save drafts, submit for approval, manage their own article drafts/updates, and delete their own articles. Published article deletion requires MFA confirmation. Regular User is not required."
        ),
        "permissions": (PERM_VIEW_ARTICLES, PERM_ADD_ARTICLES),
    },
    ROLE_ARTICLE_APPROVER: {
        "description": _(
            "Article approver. Can view articles, review pending public articles/updates, edit content while articles/updates remain pending, keep them pending after review edits, and approve or reject them; cannot create, delete, or edit already-published articles by default. Regular User is not required."
        ),
        "permissions": (PERM_VIEW_ARTICLES, PERM_MANAGE_ARTICLES),
    },
    ROLE_ARTICLE_MANAGER: {
        "description": _(
            "Article manager. Can view public articles, create public articles, edit/manage public articles, review public pending articles/updates, approve/reject submissions, and delete public articles in scope. Published article deletion requires MFA confirmation. Regular User is not required."
        ),
    ...
    ROLE_INTERNAL_ARTICLE_WRITER: {
        "description": _(
            "Internal writer add-on. Can view public/internal articles, create or maintain their own internal article drafts/submissions, and delete their own internal articles. Published internal article deletion requires MFA confirmation."
        ),
    ...
    ROLE_INTERNAL_ARTICLE_MANAGER: {
        "description": _(
            "Internal manager add-on. Can view public/internal articles, create, edit/manage, review, approve/reject internal submissions, and delete internal articles in scope. Published internal article deletion requires MFA confirmation."
        ),
